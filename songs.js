...
const SONGS = {
  ...
  furEliseOpening: {
    ...
    composer: 'Beethoven',
    bpm: 72,
    // Standard Henle-ish fingering for the famous opening.
    notes: [
      ...seq('r', 0, [
        // Opening motif
        'E5/5',0.25, 'D#5/4',0.25,
        'E5/5',0.25, 'D#5/4',0.25, 'E5/5',0.25, 'B4/1',0.25, 'D5/3',0.25, 'C5/2',0.25,
        'A4/2',0.75,
        'rest',0.75,
        'rest',0.25, 'C4/1',0.25, 'E4/2',0.25, 'A4/4',0.25, 'B4/5',0.75,
        'rest',0.25, 'E4/1',0.25, 'G#4/2',0.25, 'B4/4',0.25, 'C5/5',0.75,
        'rest',0.25, 'E4/1',0.25, 'E5/5',0.25, 'D#5/4',0.25,
        // Repeat of opening motif
        'E5/5',0.25, 'D#5/4',0.25, 'E5/5',0.25, 'B4/1',0.25, 'D5/3',0.25, 'C5/2',0.25,
        'A4/2',0.75,
        'rest',0.75,
        'rest',0.25, 'C4/1',0.25, 'E4/2',0.25, 'A4/4',0.25, 'B4/5',0.75,
        'rest',0.25, 'E4/1',0.25, 'C5/5',0.25, 'B4/4',0.25, 'A4/3',1.5,
      ]),
      // LH broken chords: pinky on bass, then thumb up.
      ...seq('l', 2.0, [
        'A2/5',0.25, 'E3/2',0.25, 'A3/1',0.25, 'rest',0.75,
        'E2/5',0.25, 'E3/2',0.25, 'G#3/1',0.25, 'rest',0.75,
        'A2/5',0.25, 'E3/2',0.25, 'A3/1',0.25, 'rest',0.75,
      ]),
      ...seq('l', 6.0, [
        'A2/5',0.25, 'E3/2',0.25, 'A3/1',0.25, 'rest',0.75,
